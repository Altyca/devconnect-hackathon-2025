...
_nav = dbc.Row([
        dbc.Col([], width = 1),
        dbc.Col([
            html.Img(src="assets/img/Databricks-logo.png", alt="image", disable_n_clicks = True, className = 'nav-img')
        ], width = 1, className = 'nav-img-col'),
        dbc.Col([
            dbc.Row([html.P(["Databricks DAIS25", html.Br(), "Hackaton"], className = 'nav-p')])
        ], width = 3),
        dbc.Col([], width = 3),
        dbc.Col([
